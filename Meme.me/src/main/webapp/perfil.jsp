                    ...
                    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:550px">
                        <form class="w3-container" action="" method="POST">
                            <div class="w3-section">
                                ...
                                <input type="radio" name="private" value="true" id="true" <% if (user.isPrivado()) out.print("checked");%>/>Privado
                                <input type="radio" name="private" value="false" id="false" <% if (!user.isPrivado()) out.print("checked");%>/>Público
                                <br>
                                ...
                                <option value="África do Sul" <% if (user.getPais()=="África do Sul") out.print("selected");%>>África do Sul</option>
                                ...
                                <option value="Brasil" <% if (user.getPais()=="Brasil") out.print("selected");%>> Brasil</option>
