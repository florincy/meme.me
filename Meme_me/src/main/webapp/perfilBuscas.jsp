...
<html>
    ...
    <body>
        <%
            ...
            String cdSeguido = String.valueOf(usuario.getCdUsuarioMeme());
            System.out.println(cdSeguido);
            String cdSeguidor = String.valueOf(user.getCdUsuarioMeme());
            System.out.println(cdSeguidor);
            Query query4 = session2.createQuery("from Follow where follower_cd_user_meme='" + cdSeguidor + "'and followed_cd_user_meme='" + cdSeguido + "'");
            Follow jaSeguida = (Follow) query4.uniqueResult();
            try {
                ...
                <form action="ServletSeguirUsuarioMeme" method="post">
                    <%
                        ...
                        if (user.getCdUsuarioMeme() == usuario.getCdUsuarioMeme()) {
                            ...
                            out.print("<button type=" + "\"submit\"" + "class=\"w3-button w3-large\"" + "style=\"position: relative; left: 83px;background-color: #28bfa0;color: #f5f6f7;\"" + ">" + botao + "</button>");
                        }
                    %>
