                                ...
                                <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
                                    ...
                                    <form class="w3-container" action="ServletLogin" method="POST">
                                        <div class="w3-section">
                                            ...
                                            <input type="text" id="email" placeholder="Digite seu Email" class="w3-input w3-border w3-margin-bottom" name="email" required>
                                    ...
                                    <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
                                        ...
                                        <span class="w3-right w3-padding w3-hide-small">Esqueceu a 
                                            <a href="esqueceu_a_senha.html">senha?</a>
                                        </span>
                                    </div>
                                    </li>
                                    <li>
                                        <button onclick="document.getElementById('id02').style.display = 'block'" class="w3-button w3-large" id="botao2">
                                            Cadastro
                                        </button>
                                        <div id="id02" class="w3-modal">
                                            <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
                                                <div class="w3-center">
                                                    <br>
                                                    <span onclick="document.getElementById('id02').style.display = 'none'" class="w3-button w3-xlarge w3-transparent w3-display-topright" title="Close Modal">
                                                        X
                                                    </span>
                                                </div>
                                                <form class="w3-container" action="ServletCadastroUsuario" method="post" enctype="multipart/form-data">
                                                    <div class="w3-section">
                                                        <label for="email" id="email">
                                                            Email:
                                                        </label>
                                                        <input type="text" id="email" placeholder="Digite seu Email" class="w3-input w3-border w3-margin-bottom" name="email">
                                                        <label for="nome" id="nome">
                                                            Nome:
                                                        </label>
                                                        <input type="text" id="nome" placeholder="Digite seu nome" class="w3-input w3-border w3-margin-bottom" name="nome">
                                                        ...
                                                        <input type="text" id="nick" placeholder="Digite seu nick" class="w3-input w3-border w3-margin-bottom" name="nick">
                                                        <label for="senha" id="senha">
                                                            Senha:
                                                        </label>
                                                        <input type="password" id="senha" placeholder="Digite sua senha" class="w3-input w3-border w3-margin-bottom" name="senha">
                                                        ...
                                                        <select name="pais">
                                                            ...
                                                            <option value="Lituania" id="Lituania">Lituânia</option>
                                                        ...
                                                        <input type="radio" name="private" value="true"/>Privado
                                                        <input type="radio" name="private" value="false"/>Público
                                                        <br>
